...
const
GumpIgnore=0;
IngotsStorage = $4013F33B; // Pecho en una casa en la que se plieguen picado.

HomeRuneBook = $40450479; // Runabuki ID srunkoy la casa.
...
Axe = $40F41FFC; // Hacha ID que Ruban.
...
begin
  ...
  cTime:=Now;
  RuneBooks:=[$4071F020,$4071F291,$406E3CF7,$406923A2,$4071F113]; 
